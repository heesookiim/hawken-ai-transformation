...
import { createStrategies, StrategyFeedback, Strategy } from '../ai/engines/strategy.js';
import { validateStrategies, ValidatedStrategy } from '../ai/engines/validation.js';
import { createImplementationPlan } from '../ai/engines/implementation.js';
import { checkFeasibility, FeasibilityResult } from '../ai/engines/feasibility.js';
import fs from 'fs';
